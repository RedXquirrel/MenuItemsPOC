...
extern void *mono_aot_module_MenuItemsPOC_iOS_info;
...
void xamarin_register_modules_impl ()
{
	...
	mono_aot_register_module (mono_aot_module_MenuItemsPOC_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MenuItemsPOC.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
